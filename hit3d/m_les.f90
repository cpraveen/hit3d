...
!
!  Time-stamp: <2009-08-19 14:54:13 (chumakov)>
!================================================================================
module m_les
...
!!$    sgs_fluxes_scalars: do n = 1, n_scalars+n_les
    ...
    ! Maybe the active scalars (BT) and (eps T) do not need SGS transport?!
    ! Trying this out: using SGS transport models only for the passive scalars now.
